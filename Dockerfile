...
RUN rm /opt/liferay-portal-6.2-ce-ga6/tomcat-7.0.62/config/context.xml
COPY lep/Configs/context.xml /opt/liferay-portal-6.2-ce-ga6/tomcat-7.0.62/conf/context.xml
